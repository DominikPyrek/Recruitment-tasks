    ...
    for data in expenses:
        ...
        if ilosc_wydatkow == 0:
            ...
            if ilosc_wydatkow % 2 == 1:
                mediany[data] = wydatki[x]
            else:
                mediany[data] = ((wydatki[x - 1] + wydatki[x]) / 2)
    return mediany
...
def solution2(expenses):
    ...
    for data in expenses:
        ...
        if ilosc_wydatkow % 2 == 1:
            mediana = quickselect(wydatki, ilosc_wydatkow // 2)
        else:
            mediana = ((quickselect(wydatki, (ilosc_wydatkow - 1 ) // 2) + quickselect(wydatki, ilosc_wydatkow // 2) )/ 2 )
        mediany[data] = mediana
    return mediany
